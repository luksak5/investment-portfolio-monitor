...
import { TrendingUp, Download, Calendar, FileText, Search, Check, ChevronsUpDown, DollarSign, Percent, BarChart3, TrendingDown, PieChart, Activity } from 'lucide-react';
...
const AdvisorReports = () => {
  ...
  const aumData = [
    { month: 'Jan 2024', value: 890000 },
    { month: 'Feb 2024', value: 920000 },
    { month: 'Mar 2024', value: 945000 },
    { month: 'Apr 2024', value: 965000 },
    { month: 'May 2024', value: 980000 },
    { month: 'Jun 2024', value: 1025000 },
  ];
  ...
  const clients = [
    { id: 'ACC001', name: 'John Smith' },
    { id: 'ACC002', name: 'Sarah Johnson' },
    { id: 'ACC003', name: 'Michael Davis' },
    { id: 'ACC004', name: 'Emily Brown' },
    { id: 'ACC005', name: 'David Wilson' },
  ];
      ...
      <div className="space-y-6">
        ...
        {selectedClient && (
          <>
            ...
            {/* Charts and Additional Content - same as AdminReports */}
